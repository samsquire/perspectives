...
These thoughts are just perspectives. They are mine. You should read everything here as if I'm saying "for me" or "from my perspective". If you have the time and you think I don't understand something then I welcome knowledge sharing of your own perspective to help me understand. Please break down your perspective into assertions of what is true.  If I don't understand something, maybe you know or assert something that I don't or never thought about? You can email me at sam@samsquire.com
...
What I've noticed is that technology is kingdoms that are understood by small groups of people. Any given codebase is really well understood by a one person, the person(s) that wrote it. Then when those people stop working on that project, it becomes "complete" and slowly becomes less used. Mozilla Thunderbird is an example of this. **The code is sufficiently complicated that you cannot informally work on the software without a large investment in understanding how it works.**
...
I am simultaneously unsatisfied with software of today and amazed by it.



# my desires for technology

I prefer code that suits my mental model of the problem of expression, of what I want to do to the data or what is on the screen and what I can do with it. So this includes mental ideas such as rotations, associations, traversals of graphs or trees. I also enjoy mechanical sympathy. This is one of the ways how my mind works. You could say this is data structure thinking or transformation pipeline thinking.
...
|Topic|Comments|
|--|--|
|Microsoft Windows|I grew up on Windows and then used Ubuntu but I am back on Windows. Windows generally works fine for me. Windows graphics, audio and network stacks just work. Occasionally my monitor does not wake up the machine and I need to hard reset. Occasionally the monitor flickers on-and-off and I have to power cycle the monitor.|
|Linux|Linux is great.|
...
I am frustrated how language features interact - look at Rust and C++. Async, move semantics, borrow checking, traits affect how you design your software because they can only be used in certain ways.
